...
Deno.serve(async (req) => {
  try {
    ...
    await sql`CREATE INDEX IF NOT EXISTS idx_jobs_instance_id ON jobs(instance_id)`;
    await sql`CREATE INDEX IF NOT EXISTS idx_jobs_status ON jobs(status)`;
    await sql`CREATE INDEX IF NOT EXISTS idx_job_logs_job_id ON job_logs(job_id)`;
    await sql`CREATE INDEX IF NOT EXISTS idx_instances_status ON database_instances(status)`;
